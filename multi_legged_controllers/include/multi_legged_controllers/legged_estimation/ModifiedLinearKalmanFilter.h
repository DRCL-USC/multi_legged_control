...
namespace legged
{
  ...
  class ModifiedKalmanFilterEstimate : public ModifiedStateEstimateBase
  {
  public:
    ModifiedKalmanFilterEstimate(PinocchioInterface pinocchioInterface, CentroidalModelInfo info, const PinocchioEndEffectorKinematics &eeKinematics, const std::string ns);
