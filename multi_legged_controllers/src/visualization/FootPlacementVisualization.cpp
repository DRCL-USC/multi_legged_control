...
namespace legged {
FootPlacementVisualization::FootPlacementVisualization(const std::string ns, const ConvexRegionSelector& convexRegionSelector, size_t numFoot,
